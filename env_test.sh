...
# put the user dirs on PATH in login-shell order -- scripts and bin
# prepended, cargo and .local/bin appended -- and export GOPATH=$HOME.
################################################################################
...
assert_equal "$_fakehome/scripts:$_fakehome/bin:$_before:$_fakehome/.cargo/bin:$_fakehome/.local/bin" "$_path"
